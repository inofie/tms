...
<head>
    ...
    <script type="text/javascript" src="{{asset('df/js/jquery-1.10.2.min.js')}}"></script>
    ...
    <div class="row">
      ...
      <div class="row lr_top">
             ...
             <div class="row">
                ...
                <div class="col-xs-4 col-md-4 col-lg-4 pull-left ">
                    <div class="panel panel-default margin-bottom-5 ">
                         <div class="panel-heading font_size_width"><b>TYPE :</b> @if($data->import ==1) IMPORT @else EXPORT @endif</div>
                    </div>
                </div>
