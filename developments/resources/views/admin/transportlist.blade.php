                      ...
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
                              <div class="btn-group pull-right">
                                 <a href="{{ route('transporteradd') }}"> <button  class="btn btn-success"><!-- id="editable-sample_new" -->
                              ...
                              <tr class="table_space">
                                  ...
                                  <td class="edit_delete">
                                    <a href="{{ route('transporteredit',['id'=>$value->myid]) }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                      <a href="{{ route('transporterdelete',['id'=>$value->myid]) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a></td>
