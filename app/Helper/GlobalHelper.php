...
class GlobalHelper
{
  ...
  */
  ...
  public static function sendFCMIOS($title, $message, $target = 0,$order_id,$user_type,$notification_type,$id){
      //$baseurl="http://".url();
      //FCM api URL
      $url = 'https://fcm.googleapis.com/fcm/send';
      //api_key available in Firebase Console -> Project Settings -> CLOUD MESSAGING -> Server key
      $server_key = "AAAAS8OSSgo:APA91bFR1Y4Fj81bjSj000bi6BVomMiBpgDZaTdhL7ewoJ9U10ty2CogFDFAwPh8oyOihZfF_6eVKbhvbLL9_Ef2VjzdOTWoYmdrZx9rhSeB2yd9A_XqG6ARp0RpoK-72xOVW7uYQOPr";

      $fields = array();
      $fields['notification'] = array();
      $fields['notification']['body'] = $message;
      $fields['notification']['title'] = $title;
      $fields['notification']['notification_id'] = $id;
      $fields['notification']['order_id'] = $order_id;
      $fields['notification']['user_type'] = $user_type;
      ...
      $fields['data']['order_id'] = $order_id;
      $fields['data']['user_type'] = $user_type;
  ...
  */
  public static function sendFCM($title, $message, $target,$order_id,$user_type,$notification_type,$id){
    //$baseurl="http://".url();
    //FCM api URL
    $url = 'https://fcm.googleapis.com/fcm/send';
    //api_key available in Firebase Console -> Project Settings -> CLOUD MESSAGING -> Server key
