...
class DriverDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
       return datatables($query)
        ...
        return 
        '<a class="label label-success" href="' . route('driveredit',$id) . '"  title="Update"><i class="fa fa-edit"></i>&nbsp</a>
        <a class="btn btn-danger btn-xs" href="'. route('driverdelete',$id) .'" title="Delete"><i class="fa fa-trash-o "></i></a>';
        })
