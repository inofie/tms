...
class ShipmentFilter1DataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
       return datatables($query)
        ->addColumn('action', function ($shipment)
        {
            ...
            $view ='<a href="' .route('forwarder-downloadlr',$id) . '" style="margin-top: 2%;width: auto; margin:1%;width:auto;" class="btn btn-danger btn-xs {{ $value->shipment_no }}hide "><i class="fa fa-download "></i> LR</i></a>';
            
            $edit = '<a href="' . route('forwarder-shipmentdetail',$id). '" style="margin-top: 2%;width: auto; margin:1%;width:auto;background-color: #047fb9;border-color: #047fb9;color: #fff" class="btn  btn-xs "><i class="fa fa-eye"></i> View</a>';
            
            $shipmentSummary='
            <a href="' . route('forwarder-allshipmentsummarylist',['shipment_no'=>$shipment_no]). '" style="margin-top: 3%;width: auto;min-width: 60%;background-color: #673ab7;border-color: #673ab7;color: #fff" class="btn  btn-xs "><i class="fa fa-eye"></i> Shipment Summary</a>';
            
            return $view.' '.$shipmentSummary.' '.$edit;
        })
