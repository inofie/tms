...
*/
                ...
                return redirect()->route('warehouseshiplistwarehouse')->with('success','Shipment successfully Created.');
        ...
        'amount' => 'required|numeric',
         ...
         'amount.required' => "Please Enter Amount",
              ...
              $shipment_data = Shipment::where('shipment_no', $Request->shipment_no)->first();
                ...
                return redirect()->route('warehouseshiplistwarehouse')->with('success', "Expense Successfully Add.");
       ...
       $this->validate($Request, [
        ...
        'weight'=>'required',
         ...
         'weight.required' => "Please Enter Weight",
                ...
                return redirect()->route('warehouseshiplistwarehouse')->with('success','Shipment successfully Updated.');
    ...
    public function ShipmentDelete(Request $Request)
    {
        ...
        return redirect()->route('warehouseshiplistwarehouse')->with('success','Shipment successfully Deleted.');
    ...
    public function WarehouseShipmentList(Request $Request)
    {
        ...
        $data = Shipment::select("shipment.*","warehouse.name as wname")
                            ...
                            ->where('warehouse_id',$ff->id)
                            ->get();

              // dd($data);

        return view('warehouse.shipmentwarehouselist',compact('data'));
    ...
    public function ShipmentAllList(Request $Request)
    {
        ...
        $ff= Transporter::where('user_id',Auth::user()->id)->first();
        $data = Shipment::where('all_transporter',$ff->id)->whereRaw('DATEDIFF(CURDATE(),date) >= 6')->get();
        //dd($data);
	...
	public function MyFilter(Request $Request)
	{
		...
		if(Auth::user()->role == "warehouse") {
            $ff= Warehouse::where('user_id',Auth::user()->id)->first();
            $datas = Shipment::where('warehouse_id',$ff->id);
            }
            else{
