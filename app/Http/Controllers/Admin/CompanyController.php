...
class CompanyController extends Controller
{
    ...
    // }
    public function List(Builder $builder, CompanyDataTable $dataTable,Request $Request)
	{
		...
		if(request()->ajax()) {
			$data1 =Company::orderby('id','desc')->get();
			return $dataTable->dataTable($data1)->toJson();
		}
		return view('admin.companylist',compact('html'));
	}
