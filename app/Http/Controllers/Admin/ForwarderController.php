...
use App\DataTables\ForwarderDataTable;
class ForwarderController extends Controller
{
    ...
    // }
    public function List(Builder $builder, ForwarderDataTable $dataTable,Request $Request)
	{
		$html = $builder->columns([
			...
			['data' => 'gst_no', 'name' => 'gst_no','title' => 'GST Number'],
		...
		if(request()->ajax()) {
			$data1 =Forwarder::orderby('id','desc')->get();
			return $dataTable->dataTable($data1)->toJson();
		}
		return view('admin.forwarderlist',compact('html'));
	}
