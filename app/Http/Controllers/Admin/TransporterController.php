...
class TransporterController extends Controller
{
    ...
    // }
    public function List(Builder $builder, TransporterDataTable $dataTable)
    {
        $html = $builder->columns([
            ...
            ['data' => 'user_id', 'name' => 'user_id','title' => 'Transport','orderable' => false, 'searchable' => false],
            ['data' => 'status', 'name' => 'status','title' => 'Status'],
            ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false,'title' => 'Action'],
        ]);
        $data= array();
        if(request()->ajax()) {
            $data1 = Transporter::orderBy('created_at','desc');
            return $dataTable->dataTable($data1)->toJson();
        }
        return view('admin.transportlist',compact('data','html'));
    }
     ...
     public function Save(Request $Request)
    {
        ...
        'rcbook'=>'required|mimes:jpeg,jpg,png|max:2560',
        'username'=>'required',
