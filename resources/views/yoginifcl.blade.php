  ...
  <body>
    <div class="invoice-box">
      <table style="width: 100%">
        <tr>
          <td>
            <img style="width: 100%;" src="{{ asset('public/uploads/y.jpg')}}">
          </td>
        </tr>
      </table>
      ...
      <table>
        <tr>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 13.33%; border-radius: 5px">@if($data->imports == 1) IMPORT @else EXPORT @endif</td>
