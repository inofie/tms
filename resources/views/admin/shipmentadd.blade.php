  ...
  <section class="wrapper">
    <!-- page start-->
    <div class="row">
      <div class="col-lg-12"> @if ($message = Session::get('success')) <div class="alert alert-success alert-block">
        ...
        </div> @endif <section class="panel">
          <header class="panel-heading " style="line-height: 30px;"> Add Shipment <div class="btn-group pull-right">
              <a href="{{ URL::previous() }}">
          ...
          <div class="panel-body">
            <div class="form">
              <form class="cmxform form-horizontal tasi-form" id="shipmentform" method="post" action="{{ route('shipmentsave') }}" enctype="multipart/form-data"> @csrf <div class="form-group">
                  <label class="control-label col-lg-2">Date <span style="color: red">*</span>: </label>
                  <div class="col-md-3 col-lg-3"> @if(old('date')) <input class="form-control" name="date" type="date" value="{{ old('date') }}"> @else <input class="form-control" name="date" type="date" value="{{ date('Y-m-d') }}"> @endif @error('date') <span class="text-danger"> {{ $message }} </span> @enderror </div>
                </div>
                <div class="form-group ">
                  <label for="cars" class="control-label col-lg-2">Choose Company <span style="color: red">*</span>: </label>
                  <div class="col-lg-10">
                    <select class="form-control" name="company" id="company">
                      <option value="">Choose Company</option> @foreach($company as $value) @if(old('company') == $value->id) <option data-code="{{ $value->code }}" data-no="{{ $value->last_no }}" selected="selected" value="{{ $value->id }}">{{ $value->name }}</option> @else <option data-code="{{ $value->code }}" data-no="{{ $value->last_no }}" value="{{ $value->id }}">{{ $value->name }}</option> @endif @endforeach
                    </select> @error('company') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <div class="col-lg-6"> @if(old('type1') == "export") <div class="radio">
                        <label>
                          <input type="radio" name="type1" id="import" value="import"> Import </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="type1" id="export" checked="checked" value="export"> Export </label>
                      </div> @else <div class="radio">
                        <label>
                          <input type="radio" name="type1" id="import" checked="checked" value="import"> Import </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="type1" id="export" value="export"> Export </label>
                      </div> @endif
                    </div>
                    <div class="col-lg-6"> @if(old('type2') == "fcl") <div class="radio">
                        <label>
                          <input type="radio" name="type2" id="lcl" value="lcl"> LCL </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="type2" id="fcl" checked="checked" value="fcl"> FCL </label>
                      </div> @else <div class="radio">
                        <label>
                          <input type="radio" name="type2" id="lcl" checked="checked" value="lcl"> LCL </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="type2" id="fcl" value="fcl"> FCL </label>
                      </div> @endif
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="text" class="form-control" id="From" name="from1" value="{{ old('from1') }}" placeholder="From" /> @error('from1') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-lg-2 control-label">To <span style="color: red">*</span>: </label>
                  <div class="col-lg-10">
                    <input type="text" name="to1" value="{{ old('to1') }}" class="form-control" placeholder="To" /> @error('to1') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                <div id="myfcls"></div>
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <select class="form-control" name="truck_type">
                      <option value="">Choose Truck Type</option> @foreach($truck_type as $value) @if(old('truck_type') == $value->id) <option selected="selected" value="{{ $value->id }}">{{ $value->name }}</option> @else <option value="{{ $value->id }}">{{ $value->name }}</option> @endif @endforeach
                    </select> @error('truck_type') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                <div class="form-group mytransporter">
                  ...
                  <div class="col-lg-10">
                    <select class="form-control" name="transporter" id="transporter">
                      <option value="">Choose Transporter</option> @foreach($transporter as $value) @if(old('transporter') == $value->id) <option selected="selected" data-number="{{ $value->truck_no }}" value="{{ $value->id }}">{{ $value->name }}</option> @else <option data-number="{{ $value->truck_no }}" value="{{ $value->id }}">{{ $value->name }}</option> @endif @endforeach
                    </select> @error('transporter') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="text" class="form-control" placeholder="Truck Number" id="truck_no" name="truck_no" value="{{ old('truck_no') }}" /> @error('truck_no') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10"> @if(old('show_detail') == 1) <div class="radio">
                      <label>
                        <input type="radio" name="show_detail" value="1"> NO </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="show_detail" checked="checked" value="1"> YES </label>
                    </div> @else <div class="radio">
                      <label>
                        <input type="radio" name="show_detail" checked="checked" value="0"> NO </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="show_detail" value="1"> YES </label>
                    </div> @endif
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="text" class="form-control" name="package" value="{{ old('package') }}" placeholder="10" /> @error('package') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="text" class="form-control" name="weight" placeholder="1000" value="{{ old('weight') }}" /> @error('package') <span class="text-danger"> {{ $message }} </span> @enderror
                  </div>
                </div>
                <div class="form-group">
            ...
            <div id="hfcls" style="display: none;">
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" class="form-control" value="{{ old('to2') }}" name="to2" placeholder="To" /> @error('to2') <span class="text-danger"> {{ $message }} </span> @enderror
                </div>
              </div>
              <div id="hfcl" style="display: none;">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-lg-3"> @if(old('destuffing')) <input type="date" id="dds" name="destuffing" class="form-control" value="{{ old('destuffing') }}"> @else <input type="date" id="dds" name="destuffing" class="form-control" value=""> @endif </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
  ...
  lclclick();
    ...
    function fclclick(){
    var fclclick = $('#hfcl').html();
  // console.log(fclclick);
      console.log(fclclick);
    $('#myfcl').html(fclclick);
    $('#hfcl').html('');

    var impo2 = $('#hfcls').html();
    $('#myfcls').html(impo2);
    $('#hfcls').html('');
}
  
function lclclick(){
  var lclclick = $('#myfcl').html();
  // console.log(lclclick);
  $('#hfcl').html(lclclick);
  $('#myfcl').html('');

  var myfcls = $('#myfcls').html();
  $('#hfcls').html(myfcls);
  $('#myfcls').html('');
  }
