                        ...
                        <section class="panel">
                            <header class="panel-heading ">
                               ...
                               <div class="btn-group pull-right">
                                 <a href="{{ route('companylist') }}"> <button style="padding: 7%;" class="btn btn-info"><!-- id="editable-sample_new" -->
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('companyupdate') }}" enctype="multipart/form-data">
                                      @csrf
                                      <input type="hidden" name="id" value="{{ $data->id }}">
                                        ...
                                        <div class="form-group ">
                                          <label for="cars" class="control-label col-lg-2">Choose LR<span style="color: red">*</span>:</label>
                                           <div class="col-lg-10">
                                           <select class="form-control" name="lr" id="company" required="required">
                                              <option value="">Choose LR</option>
                                              @foreach($lrlist as $value)
                                              @if($data->lr == $value)
                                      ...
                                      <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="gst" name="gst" @if(old('gst')) value="{{ old('gst') }}" @else value="{{ $data->gst_no }}" @endif placeholder="Enter GST Number"/>
                                                @error('gst')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                      ...
                                      <h4><u>Login Details</u></h4>
                                       ...
                                       <div class="form-group save_cancle">
                                            <div class="col-lg-12 center">
                                                ...
                                                <a href="{{route('companylist') }}" class="btn btn-default" type="button">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
