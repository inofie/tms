                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                ...
                                <form class="cmxform form-horizontal tasi-form" id="shipmentform" method="post" action="{{ route('shipmentwareupdate') }}" enctype="multipart/form-data">
                                  @csrf
                                  ...
                                  <div class="col-md-3 col-lg-3">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group ">
                                          <label for="cars" class="control-label col-lg-2">Truck Type<span style="color: red">*</span>:</label>
                                           <div class="col-lg-10">
                                           <select class="form-control" name="truck_type" required="required" >
                                      ...
                                      <div class="form-group" style="margin-top:1%;">
                                          <div class="col-lg-12" style="text-align: center;">
                                              ...
                                              <button style="display: none;"  id="sform" class="btn btn-success" type="submit">Save</button>
                                               <a href="{{route('shipmentlist')}}" class="btn btn-default">Cancel</a>
                                          </div>
                                      </div>
