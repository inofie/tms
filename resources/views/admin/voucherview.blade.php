                          ...
                          <header class="panel-heading" style="border-bottom: 1px solid #2a3542;line-height: 30px;">
                            Voucher Detail
                             <div class="btn-group pull-right">
                                ...
                                <a href="{{ route('voucherlist') }}" style="min-width: 20%; width: auto;" class="btn btn-primary "><i class="fa fa-reply"></i> Back</a>
                                </div>
                          </header>
                          <div class="panel-body">
                              <div class="form">
                                ...
                                <form class="cmxform form-horizontal tasi-form" >
                                  ...
                                  <div class="form-group">
                                    <label class="control-label col-lg-1"></label>
                                  <label class="control-label col-lg-11">Amount : <b>{{$data->amount }}</b> </label>
                                  </div>
                            ...
                            <table class="table table-striped table-hover table-bordered" >
                              ...
                              <th class="center" style="text-align: right;">Amount</th>
                               ...
                               <?php $aa = 0; ?>
                                ...
                                <td class="center" style="text-align: right;">{{ $value['total'] }}</td>
                                <?php $aa = $aa+$value['total']; ?>
                                </tr>
                                @endforeach
                                <tr>
