                ...
                <!-- page start-->
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" method="POST" action="{{ route('voucherldebitsave') }}">
                                      @csrf
                                        ...
                                        <div class="form-group ">
                                         ...
                                         <div class="form-group " id="transporter_div">
                                            <label for="transporter_id" class="control-label col-lg-2"> To Transporter :</label>
                                            <div class="col-lg-10">
                                         ...
                                         <div class="form-group " id="forwarder_div">
                                            <label for="forwarder_id" class="control-label col-lg-2"> To Forwarder :</label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group " id="fcompany_id">
                                            <label for="fcompany_id" class="control-label col-lg-2"> To Company :</label>
                                            <div class="col-lg-10">
...
<script type="text/javascript">
    ...
    $("#fcompany").change(function(){
        ...
        $("#company option[value='"+trans+"']").prop('disabled', false); 
        } else {
          ...
          $("#forwarder").val("");
           ...
           $("#company option[value='"+trans+"']").prop('disabled', true); 
        }  
    ...
    $("#company").change(function(){
        ...
        if(trans == ''){
            ...
            $("#fcompany option[value='"+trans+"']").prop('disabled', false);
        } else {

          $("#fcompany option[value='"+trans+"']").prop('disabled', true);
