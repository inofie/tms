                ...
                <!-- page start-->
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('employeeupdate') }}" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <img src="{{ asset('public/uploads') }}/{{ $data->pan_card }}" id="item-img-output" style="margin-top: 1%;float: left;" width="100px" alt="" class="zoom">
                                                </div>
                                                @error('pan_card')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
