                ...
                <!-- page start-->
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('driverupdate') }}" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                <input required="required" class=" form-control" id="name" name="name" type="text" value="{{ $data->name }}" placeholder=" Enter Name" />
                                                @error('name')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input required="required" type="text" class="form-control" id="pan" name="pan" value="{{ $data->pan }}"  placeholder="PAN Number"/>
                                                 @error('pan')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div style=" overflow: hidden; width: 100px; ">
                                                <img src="{{ asset('public/uploads') }}/{{ $data->licence }}" id="item-img-output" style="margin-top: 1%;float: left;" width="100px" alt="" class="zoom">
                                                </div>
                                                @error('licence')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
