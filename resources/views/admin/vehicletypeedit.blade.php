                ...
                <!-- page start-->
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('transporttypeupdate') }}" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <input type="hidden" name="id" value="{{ $data->id }}">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="name" name="name" type="text" required="required" value="{{ $data->name }}" placeholder=" Enter Truck Type Name" />
                                         ...
                                         <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="sorting" name="sorting" type="text" required="required" value="{{ $data->sorting }}" placeholder="1" />
