                ...
                <!-- page start-->
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" method="POST" action="{{ route('voucherlcreditsave') }}">
                                      @csrf
                                        ...
                                        <div class="form-group " id="fcompany_id">
                                            <label for="fcompany_id" class="control-label col-lg-2"> From Company :</label>
                                            <div class="col-lg-10">
                                        ...
                                        <div class="form-group ">
                                            <label for="company_id" class="control-label col-lg-2"> To Company :</label>
                                            <div class="col-lg-10">
...
<script type="text/javascript">
    ...
    $('#company').change(function(){
      ...
      } else if(forwarder != "" && aa != ""){

        $.ajax({
            url: "{{ route('invoicebills') }}",
            type:"POST",
            data:{
              company:aa,
              forwarder:forwarder,
