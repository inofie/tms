                        ...
                        <section class="panel">
                            <header class="panel-heading ">
                               ...
                               <div class="btn-group pull-right">
                                 <a href="{{ route('employeelist') }}"> <button style="padding: 7%;" class="btn btn-info"><!-- id="editable-sample_new" -->
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('employeesave') }}" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="email" class="form-control" id="email" name="email" required="required" value="{{ old('email') }}" placeholder="Enter Email ID"/>
                                                @error('email')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                      ...
                                      <!--   <div class="form-group ">
                                         ...
                                         <div class="form-group save_cancle">
                                            <div class="col-lg-12 center">
                                                ...
                                                <a href="{{route('employeelist') }}" class="btn btn-default" type="button">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
