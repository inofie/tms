...
<section id="main-content">
          ...
          @if ($message = Session::get('success'))
                      ...
                      @endif
                            ...
                            <div class="form">
                            <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('rolessave') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                <label  class="control-label col-lg-2" for="name">Role Name <span style="color: red"> *</span></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" autoComplete="off" id="name" name="name" placeholder="Role Name in lower case" value="{{old('name')}}"/>
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group {{ $errors->has('permission') ? ' has-error' : '' }}">
                                <label  class="control-label col-lg-12" for="name">Permission <span style="color: red"> *</span></label>
                                <div>
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            @foreach($permissions as $row)
                                                <div class="col-lg-4 col-md-3 col-sm-3">
                                                    <label class="selectOnlyCategories">{{ Form::checkbox('permission[]', $row->id, false, array('class' => 'name minimal mr-2 all '.$key.'','style'=>'margin-right: 5px;')) }}
                                                        {{ $row->name }}
                                                    </label>
                                                </div>
                                            @endforeach
