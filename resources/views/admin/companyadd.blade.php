                ...
                <!-- page start-->
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('companysave') }}" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="Enter Email ID"/>
                                                @error('email')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="gst" name="gst" value="{{ old('gst') }}" placeholder="Enter GST Number"/>
                                                @error('gst')
                                                 <span class="text-danger"> {{ $message }} </span>
                                                @enderror
                                            </div>
