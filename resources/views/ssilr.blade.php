...
<html>
    ...
    <div class="invoice-box">
      ...
      <table>
        <tr>
          <td style="width: 50%">
             <table>
                <tr>
                  <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 20%; border-radius: 5px">Consigner. : <span>Rolex Rings Private Limited</span></td>
                 
                </tr>
                <tr>
                  <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px;  padding: 5px 8px; line-height: 1.2; width: 20%; border-radius: 5px" >Address :</strong><br>
                         Gondal Road, Village Kotharia,Rajkot - 60004(Gujarat) India</td>
                </tr>
                <tr>
                  <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 20%; border-radius: 5px">Consignee. : <span>Jas Forwording Worldwide Serv</span></td>
                </tr>
              ...
              <table>
                  <tr>
                    ...
                    <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 20%; border-radius: 5px">Invoice No.</td>
                            ...
                            <td style="border: 1px solid #dedede ;text-align: center; font-size: 12px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">H0727/20-21</td>
                  ...
                  <tr>
                    <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 20%; border-radius: 5px">Date.</td>
                            ...
                            <td style="border: 1px solid #dedede ;text-align: center; font-size: 12px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">31-March-2021</td>
                  </tr>
                   <tr> 
                  ...
                  <td style="border: 1px solid #dedede ;text-align: center; font-size: 12px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">Ahmedabad</td>
                   </tr>
                  <tr>
                  ...
                  <td style="border: 1px solid #dedede ;text-align: center; font-size: 12px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">Rajkot</td>
                  </tr>
                  <tr>
                    <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 20%; border-radius: 5px">Type.</td>
                            ...
                            <td style="border: 1px solid #dedede ;text-align: center; font-size: 12px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">IMPORT</td>
                  </tr>
      ...
      <table>
        <tr>
          ...
          <td style="border: 1px solid #dedede ; font-size: 12px; text-align: left;  padding: 5px 8px; line-height: 1.2; width: 85%; border-radius: 5px" >GJ03BV9633, GJ03BV9633, GJ03BV9633,GJ03BV9633m, GJ03BV9633, GJ03BV9633</td>       
        </tr>
      </table>
 ...
 <table>
              ...
              <tr>
                ...
                <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 39%; line-height: 1.2;  padding: 5px; border-radius: 5px;">9 Package Only</td>
       ...
       <table>
           <tr>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 10%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Consignee:</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">jitesh bhai</td>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 10%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Consignee:</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">jitesh bhai</td>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Truck Type:</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">Hatchback</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 20%; line-height: 1.2;  padding: 5px; border-radius: 5px;" rowspan="2">&nbsp;</td>

           </tr>
           <tr>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 10%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Private Mark: </td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">jitesh bhai</td>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 10%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Invoice No: </td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">jitesh bhai</td>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Truck Driver Name:</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">Hatchback</td>
               

           </tr>
           <tr>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 10%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Enclosures: </td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">jitesh bhai</td>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 10%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">B / E:</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">jitesh bhai</td>
               <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">Truck Licence No:</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 15%; line-height: 1.2;  padding: 5px; border-radius: 5px;">Hatchback</td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700; width: 20%; line-height: 1.2;  padding: 5px; border-radius: 5px;">Authorised Yogini Transport</td>
