              ...
              <!-- page start-->
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('userupdate') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group ">
                                            ...
                                            <div class="col-lg-10">
                                                <select class="form-control" name="role" id="role" required="required">
                                                   <option value=""> -- Please Select Level -- </option>
                                                      ...
                                                      @if($data->level == $value->level_name)
                                        ...
                                        <div class="form-group ">
                                            <label for="name" class="control-label col-lg-2">Select User<span style="color: red">*</span> :</label>
                                            <div class="col-lg-10">
                                            <?php
                                            $chkk = $data->depend_id;
                                            ?>
                                            <select name="depend" class="form-control" id="depend">
                                            <option value=""> -- Please Select User -- </option>
                                            @foreach ($cities as $city)
                                                
                                            <option value="{{ $city->id }}" @if($city->id == $chkk) selected @else disabled @endif>{{ $city->username }}</option>
                                            @endforeach
                                            </select>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input required="required" class=" form-control" id="username" name="username" type="text" value="{{ $data->username }}" placeholder=" Enter UserName" />
                                              @error('name')
                                               <span class="text-danger"> {{ $message }} </span>
                                              @enderror
                                          </div>
