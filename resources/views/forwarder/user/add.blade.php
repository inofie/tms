              ...
              <!-- page start-->
                      ...
                      <section class="panel">
                          <header class="panel-heading ">
                             Add User
                              <div class="btn-group pull-right">
                               <a href="{{ route('userlist') }}"> <button style="padding: 7%;" class="btn btn-info"><!-- id="editable-sample_new" -->
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('usersave') }}" enctype="multipart/form-data">
                                    @csrf
