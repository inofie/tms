              ...
              <!-- page start-->
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('levelupdate') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <input type="hidden" name="id" value="{{ $data->id }}">
                                      ...
                                      <div class="form-group ">
                                          <label for="name" class="control-label col-lg-2">Level name :</label>
                                          <div class="col-lg-10">
