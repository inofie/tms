  ...
  <body>
    <div class="invoice-box">
      ...
      <table style="border-collapse: collapse; margin-bottom: 0.5%">
                ...
                <tr class="details">
                  <td style="text-align: left; border: 1px solid #000 ;  padding:5px; width: 44%; font-size: 10px; font-weight: 600; line-height: 1; font-family:sans-serif;" rowspan="3">
                    <span style="font-size: 13px; font-weight: 700;"><strong>YOGINI TRANSPORT</strong></span><br>
        ...
        E-Mail : cakhurdia@gmail.com
                  ...
                  <td style="border: 1px solid #000 ;text-align: center; font-size: 10px; line-height: 1.2; font-weight: 700;  padding: 5px; border-bottom: 1px solid #000; width: 12%;">H0727/20-21</td>
                  ...
                  <td style="border: 1px solid #000 ;text-align: center; font-size: 10px; line-height: 1.2; font-weight: 700;  padding: 5px; border-bottom: 1px solid #000;  width: 16%;">31-Jan-2021</td>
        ...
        <tr class="details">
          ...
          <td style="border-right: 1px solid #000 ;text-align: center; font-size: 10px; line-height: 1.2; font-weight: 700;  padding: 5px; border-bottom: 1px solid #000; width: 12%;">H0727/20-21
          ...
          <td style="border-right: 1px solid #000 ;text-align: center; font-size: 10px; line-height: 1.2; font-weight: 700;  padding: 5px; border-bottom: 1px solid #000;width: 16%;">8225 Kg</td>
      ...
      <table style="border-collapse: collapse; margin-bottom: 0.5% ; border: 1px solid #000;" >
              ...
              <tr class="details">
                ...
                <td style="border: 1px solid #000 ; text-align: center; font-size: 10px; font-weight: 700; background-color: #e6e6e6; padding: 5px; line-height: 1.2; width: 15%;">From.</td>
                 <td style="border: 1px solid #000 ; text-align: left; font-size: 10px; font-weight: 700; padding: 5px; line-height: 1.2; width: 35%;"></td>
              ...
              <tr class="details">
                ...
                <td style="border: 1px solid #000 ;border-right:1px solid #000 ; text-align: left; font-size: 10px; font-weight: 700;   line-height: 1.2; width: 35%;"></td>
              </tr>
              <tr>
      ...
      <table style="border-collapse: collapse; border: 1px solid #000; margin-bottom: 0.5%;">
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; text-align: center; font-size: 13px; width:37.84%; line-height: 1.2; padding: 5px;">&nbsp;</td>
                <td style=" border-left: 1px solid #000;text-align: center; font-size: 13px; width:24.32%; line-height: 1.2; padding: 5px;">for YOGINI TRANSPORT</span></td>
      ...
      <table style="border-collapse: collapse;">
        <tr>
          <td style="text-align: center; font-size: 12px; line-height: 1.2; font-weight: 700; padding:5px; background-color: #ef7f1a; color: #fff;">Note:If Any Changes Please Inform us to within 6 days of invoice date.
</td>
