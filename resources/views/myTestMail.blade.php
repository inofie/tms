             ...
             <div class="row">
                <div class="col-xs-4 col-md-4 col-lg-4 pull-left ">
                    <div class="panel panel-default margin-bottom-5" >
                        <div class="panel-heading font_size_width"><b>L.R. No. :</b> <span>Y21-20-21</span></div>
                    </div>
                </div>

                <div class="col-xs-4 col-md-4 col-lg-4 pull-left ">
                    <div class="panel panel-default margin-bottom-5 ">
                         <div class="panel-heading font_size_width"><b>TYPE :</b> IMPORT</div>
                    </div>
                </div>
                ...
                <div class="col-xs-4 col-md-4 col-lg-4 pull-left ">
                    <div class="panel panel-default margin-bottom-5" >
                        <div class="panel-heading font_size_width"><b>Date. :</b> <span>12-12-2021</span></div>
                    </div>
                </div>
                </div>
                <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12 pull-left">
                    <div class="panel panel-default margin-bottom-5" >
                        <div class="panel-heading font_size_width"><b>Truck No. :</b> <span>GJ03BV9633</span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-6 col-md-6 col-lg-6 pull-left ">
                    <div class="panel panel-default margin-bottom-5 " >
                        <div class="panel-heading font_size_width"><b>From. :</b> <span>KOTHARIYA(RAJKOT)</span></div>
                    </div>
                </div>

                <div class="col-xs-6 col-md-6 col-lg-6 pull-left ">
                    <div class="panel panel-default margin-bottom-5" >
                         <div class="panel-heading font_size_width"><b>To. :</b> <span>NAVASEVA(GDEL)</span></div>
                    </div>
                </div>
                </div>
                ...
                <div class="col-xs-6 col-md-6 col-lg-6">
                    <div class="panel panel-default height">
                        <div class="panel-heading font_size_width"><b>Consigner. :</b> <span>Rolex Rings Private Limited</span></div>
                        <div class="panel-body font_size_width" >
                            <strong class="font_12">Address</strong><br>
                            Gondal Road, Village Kotharia,Rajkot - 60004(Gujarat) India
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-6 col-lg-6 pull-right">
                    <div class="panel panel-default height">
                       <div class="panel-heading font_size_width"><b>Consignee. :</b> <span>Jas Forwording Worldwide Serv</span></div>
                        <div class="panel-body font_size_width">
                            <strong class="font_12">Address</strong><br>
                            NAVASEVA(GDEL)
                        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class=" ">
                         ...
                         <div class="panel-heading font_size_width" >
                            <b>Total :</b> <span>9 Package Only</span>
                        </div>
                    </div>
