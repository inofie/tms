  ...
  <body>
    ...
    <div class="invoice-box">
      ...
      <table style="border-collapse: collapse; margin-bottom: 0.5%">
        ...
        <td style="border: 1px solid #000 ;text-align: center; font-size: 10px; line-height: 1.2;padding: 5px; border-bottom: 1px solid #000;  width: 16.66%;">31-Jan-2021</td>
        <td style="border: 1px solid #000 ;text-align: left; font-size: 10px; line-height: 1.2; font-weight: 700;  padding: 5px; border-bottom: 1px solid #000;  width: 16.66%; background-color: #e6e6e6;">Other Reference(s).</td>
        <td style="border: 1px solid #000 ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px; border-bottom: 1px solid #000;  width: 16.66%;">8225 Kg</td>
      ...
      <table style="border-collapse: collapse; margin-bottom: 0.5%">
        <tr class="details">
                  <td style="text-align: left; border: 1px solid #000 ;  padding:5px; width: 44%; font-size: 10px; font-weight: 600; line-height: 1.7; font-family:sans-serif;">
                    <span style="font-size: 13px; font-weight: 700;"><strong>SSI TRANSPORT</strong></span><br>
                  ...
                  <td style="text-align: left; border: 1px solid #000 ;  padding:5px; width: 50%; font-size: 10px; font-weight: 600; line-height: 1.5; font-family:sans-serif;" >
