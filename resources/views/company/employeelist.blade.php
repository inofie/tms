                      ...
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
                              <div class="btn-group pull-right">
                                 <a href="{{ route('employeeaddcompany') }}"> <button  class="btn btn-success"><!-- id="editable-sample_new" -->
                              ...
                              <tbody>
                               ...
                               <tr class="table_space">
                                  ...
                                  <td class="edit_delete">
                                    <a href="{{ route('employeeeditcompany',['id'=>$value->myid]) }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                      <button onclick="deleteItem('{{ $value->myid }}')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button>
                                      <form action="{{ route('employeedeletecompany') }}" id="delete{{$value->myid}}" method="post">
                                        @csrf
