...
<html>
  ...
  <body>
    <div class="invoice-box">
      ...
      <table>
        <tr>
         <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 15%; border-radius: 5px">Date.</td>
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">21-March-2021</td>
         <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 15%; border-radius: 5px">Type.</td>
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">IMPORT</td>
         <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 30%; border-radius: 5px">Invoice No.</td>
        </tr>
        <tr>
         <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 15%; border-radius: 5px">From.</td>
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">Ahmedabad</td>
         <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 15%; border-radius: 5px">To.</td>
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">Rajkot</td>
         <td style="border: 1px solid #dedede ; text-align: center; font-size: 15px; font-weight: 700;  padding: 5px 8px; line-height: 1.2; width: 30%; border-radius: 5px">H0727/20-21</td>
        </tr>
      </table>
      ...
      <table>
              ...
              <tr style="height: 150px;vertical-align: baseline;">
                ...
                <td td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; width: 20%; line-height: 1.2;  padding: 5px; border-radius: 5px;">&nbsp;</td>
       ...
       <table style="text-align: left; margin: 1% 0px;">
  <tr>
...
<div  style="width: 100%;">
 ...
 <p  style="padding: 0px; margin:1% 0px 0px 0px; font-size: 15px; margin-bottom: 5px; font-weight: 700" >Terms and Condition :</p>
  

  <div style="width: 50%; float: left;">
    
    <p style="padding: 0px; margin:1% 0px 0px 0px;font-size: 10px; margin-bottom: 5px; text-align: justify;padding: 1%; ">• Condition contents and value of consignment are acknowledged to yogini transport(nereinafer called the company).The company carries the goods as packed of owners of consignor's risk.
