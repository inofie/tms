             ...
             <div class="row">
                <div class="col-xs-4 col-md-4 col-lg-4 pull-left ">
                    <div class="panel panel-default margin-bottom-5" >
                        <div class="panel-heading font_size_width"><b>L.R. No. :</b> <span></span></div>
                    </div>
                </div>

                <div class="col-xs-4 col-md-4 col-lg-4 pull-left ">
                    <div class="panel panel-default margin-bottom-5 ">
                         <div class="panel-heading font_size_width"><b>TYPE :</b>  </div>
                    </div>
                </div>
                ...
                <div class="col-xs-4 col-md-4 col-lg-4 pull-left ">
                    <div class="panel panel-default margin-bottom-5" >
                        <div class="panel-heading font_size_width"><b>Date. :</b> <span></span></div>
                    </div>
                </div>
                </div>
                <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12 pull-left">
                    <div class="panel panel-default margin-bottom-5" >
                        <div class="panel-heading font_size_width"><b>Truck No. :</b> <span></span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-6 col-md-6 col-lg-6 pull-left ">
                    <div class="panel panel-default margin-bottom-5 " >
                        <div class="panel-heading font_size_width"><b>From. :</b> <span></span></div>
                    </div>
                </div>

                <div class="col-xs-6 col-md-6 col-lg-6 pull-left ">
                    <div class="panel panel-default margin-bottom-5" >
                         <div class="panel-heading font_size_width"><b>To. :</b> <span></span></div>
                    </div>
                </div>
                </div>
                ...
                <div class="col-xs-6 col-md-6 col-lg-6">
                    <div class="panel panel-default height">
                        <div class="panel-heading font_size_width"><b>Consigner. :</b> <span>\</span></div>
                        <div class="panel-body font_size_width" >
                            <strong class="font_12">Address</strong><br>\</div>
                    </div>
                </div>
                <div class="col-xs-6 col-md-6 col-lg-6 pull-right">
                    <div class="panel panel-default height">
                       <div class="panel-heading font_size_width"><b>Consignee. :</b> <span>\</span></div>
                        <div class="panel-body font_size_width">
                            <strong class="font_12">Address</strong><br></div>
                    </div>
                </div>
