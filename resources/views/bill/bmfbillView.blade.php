...
<body>
  <div class="invoice-box" style="margin-top: 20px;">
    <table style="width: 100%;ext-align:center;border: 1px solid black;" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <table style="width: 100%;margin-top: 150px;" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td style="text-align:center;">
                        <b style="font-size:36px;">INVOICE</b>
                      </td>
                    </tr>
                </table>
                <table style="width: 100%;" border="0">
                  <tr>
                    ...
                    <td style="width: 40%;">
                      <table style="width: 100%;margin-top: 31px;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="left headerClass">
                ...
                <br/><br/>
                <table style="width: 100%;padding-bottom:15px;border-collapse: separate;">
                  <tr class="item_tr">
                  ...
                  <tr class="item_tr">
                    ...
                    <td class="item_td" style="height:200px;vertical-align:top">{{ number_format($data->grand_total,2) }}</td>
                  </tr>
                  <tr class="item_tr">
                    ...
                    <td class="item_td"><b>{{ number_format($data->grand_total,2) }}</b></td>
                  </tr>
                ...
                <table style="width: 100%;padding-bottom: 15px;" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td style="width: 60%;">
                        <table style="width: 100%;margin-left: 10px;" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                              <td class="left headerClass">
