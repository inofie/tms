    ...
    <div class="invoice-box">
      ...
      <table>
        <tr>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">{{ date('d-M-Y',strtotime($data->date)) }}</td>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">@if($data->imports == 1) Import @else Export @endif</td>
        ...
        <tr>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">{{ $data->from1 }}</td>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 20%; border-radius: 5px">{{ $data->to1 }}</td>
         <td style="border: 1px solid #dedede ; text-align: center; font-size: 15px; font-weight: 700;  padding: 5px 8px; line-height: 1.2; width: 30%; border-radius: 5px">{{$data->lr_no}}</td>
        </tr>
      </table>
      ...
      <table>
              ...
              <tr style="height: 150px;vertical-align: baseline;">
                <td style="border: 1px solid #dedede ; text-align: center; font-size:10px; width:8%; line-height: 1.2; padding: 5px; border-radius: 5px;">{{ $data->package }}</td>
                <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; width: 47%; line-height: 1.2;  padding: 5px; border-radius: 5px;"><?php echo  html_entity_decode($data->description); ?></td>
                <td td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; width: 20%; line-height: 1.2;  padding: 5px; border-radius: 5px;">{{ $data->weight }}KG</td>
              ...
              <tr>
                ...
                <td style="border: 1px solid #dedede ; text-align: center; font-size: 10px; font-weight: 700; width: 39%; line-height: 1.2;  padding: 5px; border-radius: 5px;">{{ $data->package }} Package Only</td>
...
<div  style="width: 100%;">
 ...
 <p  style="padding: 0px; margin:1% 0px 0px 0px; font-size: 15px; margin-bottom: 5px; font-weight: 700" >Terms and Condition :</p>
  ...
  <div style="width: 50%; float: left;">
    ...
    <p style="padding: 0px; margin:1% 0px 0px 0px;font-size: 10px; margin-bottom: 5px; text-align: justify;padding: 1%; ">• Condition contents and value of consignment are acknowledged to bmf (nereinafer called the company).The company carries the goods as packed of owners of consignor's risk.
