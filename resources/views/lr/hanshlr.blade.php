  ...
  <body>
    <div class="invoice-box">
      <table style="width: 100%">
        <tr>
          <td>
            <img style="width: 100%;" src="{{ asset('uploads/22y.jpg')}}">
          </td>
        </tr>
      </table>
      ...
      <table >
            ...
            <tr class="details" style="">
                  ...
                  <td style="border: 1px solid #dedede ;text-align: center; font-size: 13px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">{{$data->lr_no}}</td>
            ...
            <tr class="details" style="">
                  ...
                  <td style="border: 1px solid #dedede ;text-align: center; font-size: 13px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">@if($data->imports == 1) Import @else Export @endif</td>
                   <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px;  padding: 5px 8px; line-height: 1.2; width: 50%; border-radius: 5px" rowspan="2">{{ $data->truck_no }}</td>                  
            </tr>
            ...
            <tr class="details" style="">
                  ...
                  <td style="border: 1px solid #dedede ;text-align: center; font-size: 13px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">{{ date('d-M-Y',strtotime($data->date)) }}</td>
      ...
      <table>
          <tr>
              ...
              <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px">{{ $data->from1 }}</td>
              ...
              <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 30%; border-radius: 5px"> {{ $data->to1 }}</td>
          </tr>
      </table>
      ...
      <table>
              ...
              <tr style="height: 150px;vertical-align: baseline;">
                ...
                <td style="border: 1px solid #dedede ; text-align: center; font-size:10px; width: 25%; line-height: 1.2;  padding: 5px; border-radius: 5px;"><?php echo  html_entity_decode($data->description); ?></td>
                <td style="border: 1px solid #dedede ; text-align: center; font-size:10px; width: 14%; line-height: 1.2;  padding: 5px; border-radius: 5px;">{{ $data->weight }}KG</td>
       ...
       <table>
           ...
           <tr>
              ...
              <!--- <td style="border: 1px solid #dedede ; text-align: center; font-size: 10px; font-weight: 700; width: 20%; line-height: 1.2;  padding: 5px; border-radius: 5px;">Authorised Hans Transport</td> --->
       ...
       <!-- <table>
          ...
          <table>
              ...
              <tr>
                  <td style="text-align: left; font-size: 10px;line-height: 1.2;  padding: 5px; text-align: justify; ">1.) Condition contents and value of consignment are acknowledged to hans transport(nereinafer called the company).The company carries the goods as packed of owners of consignor's risk.
...
copy of the GC of not any person who products the same 20 incase of dispute jurisdiction of court of ahmedabad.</td>
          ...
          -->
            ...
            <p style="padding: 0px;margin:1% 0px 0px 0px;font-size: 10px; margin-bottom: 5px;"> N.B. (1.)This G.C. Note Issued Under Terms &amp; Condition Printed Overleaf. (2.)We are not Responsible For Leakages.Breakages DamagesCondition Goods Accepted On Owner Risk. (3.)Subject to Ahmedabad Jurisdiction<br><br>
              ...
              :1.) Condition contents and value of consignment are acknowledged to hans transport(nereinafer called the company).The company carries the goods as packed of owners of consignor's risk.
2.)The company does not guarantee delivery within any specified time and the CO. shall not be label for any delay in transport of delivery. 3.)The co.shall not be liable for any loss or damage due to wheather conditions strikes,riotes
disturbance.Fire explosion or accidents. 4.)Delivery should be takenn from our godown for consignment less than a lorry load likewisw for collection of goods. 5.)The consignor is responsible for all consequences of and incorrecrt of
falls declaration. 6.)Delivery of goods should be taken from company's godown within days of their arrival falling which a godown rent at rates in force will be charged. The consigning of consignment shall ascreiain the time and date
arrival. 7.)The consignee copy shall be surrendered duty discharged at the time of taking delivery and once the goods are delivered the company is absolved from all liability. 8.)The company had the right tore weight re measure and re
