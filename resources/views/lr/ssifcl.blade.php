...
<div  style="width: 100%;">
 ...
 <p  style="padding: 0px; margin:0% 0px 0px 0px; font-size: 12px; margin-bottom: 5px; font-weight: 700" >Terms and Condition :</p>
  ...
  <div style="width: 50%; float: left;">
    ...
    <p style="padding: 0px; margin:0% 0px 0px 0px;font-size: 8px; margin-bottom: 5px; text-align: justify;padding: 1%; ">• Condition contents and value of consignment are acknowledged to ssi transport(nereinafer called the company).The company carries the goods as packed of owners of consignor's risk.
