...
<div style="padding: 2%;">
        ...
        <td style="width: 25%;padding: 0px 10px 0px 0px"> 
            <img src="{{asset('pdf/img/vector-lab.png')}}" alt="" style="width: 80%">
        </td> 
       <td style="width: 35%;font-size: 10px;font-family:Helvetica Neue;">
             <p>L/22, Swatantra Senani Nagar,Nava Vadaj, Ahmedabad - 3800013</p>
        </td>
       ...
       <td style="width: 30%;padding: 5px 2%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            <p style="padding: 0px;margin: 0;font-size: 10px;">L.R. No. : Y5/20-21</p>
        </td> 
       <td style="width:5%;">
             &nbsp;&nbsp;
        </td>
     <td style="width: 30%;padding: 5px 2%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            <p style="padding: 0px;margin: 0;font-size: 10px;">TYPE : IMPORT</p>
        </td>
         <td style="width: 5%;">
             &nbsp;&nbsp;
        </td>
         <td style="width: 30%;padding: 5px 2%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            <p style="padding: 0px;margin: 0;font-size: 10px;">Date. : 10-02-2021</p>
        </td>
        ...
        <td style="width: 100%;padding: 5px 2%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            <p style="padding: 0px;margin: 0;font-size: 10px;">Truck No. : GJ03BV9633,GJ03BV9633,GJ03BV9633,GJ03BV9633,GJ03BV9633,GJ03BV9633</p>  
        </td>
        </tr>    
        </tbody>
        </table>
        ...
        <td style="width: 40%;padding: 5px 2%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            <p style="padding: 0px;margin: 0;font-size: 10px;">From. : KOTHARIYA(RAJKOT)</p>  
        </td>
        ...
        <td style="width: 4%;padding: 5px 2%;"> 
         ...
         <td style="width: 40%;padding: 5px 2%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            <p style="padding: 0px;margin: 0;font-size: 10px;">To. : NAVASEVA(GDEL)</p>  
        </td>
        </tr>    
        </tbody>
        </table>
        ...
        <td style="width: 45.5%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            ...
            <p style="padding: 0px;margin: 0;font-size: 10px;padding: 5px 4%;">Consigner. : Rolex Rings Private Limited</p>
            <p style="padding: 0px;margin: 0;font-size: 10px;padding: 5px 4%;"><b>Address :</b><br>
             Gondal Road, Village Kotharia,Rajkot - 60004(Gujarat) India</p>  
        </td>
        ...
        <td style="width: 2.5%;padding: 5px 2%;"> 
         ...
         <td style="width: 45.5%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
            <p style="padding: 0px;margin: 0;font-size: 10px;padding: 5px 4%;">Consignee. : Jas Forwording Worldwide Serv</p>
            <p style="padding: 0px;margin: 0;font-size: 10px;padding: 5px 4%;"><b>Address :</b><br>
             NAVASEVA(GDEL)</p> 
        </td>
        </tr>    
                ...
                <td style="padding:0.5%;border: 1px solid #e2e2e2;width: 100%">
                    ...
                    <table  style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;width: 10%;border: 1px solid #e2e2e2;">
                                        <p style="font-size: 10px;">Actual<br>Weight</p>
                                </td>
                                <td style="text-align: center;width: 20%;border: 1px solid #e2e2e2;">
                            ...
                            <tr style="height: 150px;vertical-align: baseline;">
                                <td style="width: 5%;border: 1px solid #e2e2e2;min-height: 150px;text-align: center;">
                                        <p style="font-size: 10px;padding: 0px 0px 0px 3%;">1</p>
                                </td>
                                <td style="width: 30%;border: 1px solid #e2e2e2;">
                                        <p style="font-size: 10px;padding: 0px 0px 0px 3%;">EXPORT
                                        	<br>800 X 600 X 750)mm 9
                                        <br>800 X 600 X 750)mm 9
                                    <br>800 X 600 X 750)mm 9
                                <br>800 X 600 X 750)mm 9
                                <br>800 X 600 X 750)mm 9
                                <br>800 X 600 X 750)mm 9</p>
                                </td>
                                <td style="width: 10%;border: 1px solid #e2e2e2;">
                                        <p style="font-size: 10px;padding: 0px 0px 0px 3%;">2700KG</p>
                                </td>
                                <td style="width: 20%;border: 1px solid #e2e2e2;">
                                        <p style="font-size: 10px;padding: 0px 0px 0px 3%;"></p>
                                </td>
                                <td style="width: 15%;border: 1px solid #e2e2e2;">
                                        <p style="font-size: 10px;padding: 0px 0px 0px 3%;"></p>
                                </td>
                                <td style="width: 30%;border: 1px solid #e2e2e2;">
                            ...
                            <tr style="padding: 0px;margin: 0px;">
							        <td style="width: 40%;padding: 0.5% 2%;border: 1px solid #e2e2e2;border-radius: 5px;margin: 0px;"> 
							            <p style="padding: 0px;margin: 0;font-size: 10px;">Total : 9 Package Only</p>  
							        </td>

							         <td style="width: 60%;padding: 0.5% 2%;"> 
							            <p style="padding: 0px;margin: 0;text-align: center;font-size: 12px;"><b>GST / EWAY BILL ID : 24AACFY4389E1Z0</b></p>  
							        </td>
					        </tr>   
            ...
            <tr style="">
                <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                   ...
                   <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                	...
                	<p style="padding: 0px;margin: 0;font-size: 10px;">Truck Type:</p>
            ...
            <tr style="">
                <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                   ...
                   <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                	...
                	<p style="padding: 0px;margin: 0;font-size: 10px;">Invoice No:</p>

                   </td>
                   <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                	
                	<p style="padding: 0px;margin: 0;font-size: 10px;">Driver Name:</p>
            ...
            <tr style="">
                <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                   ...
                   <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                	...
                	<p style="padding: 0px;margin: 0;font-size: 10px;">B / E:</p>

                   </td>
                   <td style="border: 1px solid #e2e2e2;width: 24%;padding: 5px">
                	
                	<p style="padding: 0px;margin: 0;font-size: 10px;">Licence No:</p>
