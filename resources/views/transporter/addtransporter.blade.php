              ...
              <!-- page start-->
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('savetransporters') }}" enctype="multipart/form-data">
                                    @csrf
                      ...
                      <div class="adv-table" style="padding: 1%;">
                           <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr>
                                  ...
                                  <td class="center"> <form action="{{ route('deleteshiptransporters') }}" method="post">
                                      @csrf
