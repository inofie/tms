              ...
              <!-- page start-->
                      ...
                      <section class="panel">
                          <header class="panel-heading ">
                             Add Driver
                              <div class="btn-group pull-right">
                               <a href="{{ route('transporterdriverlist') }}"> <button style="padding: 7%;" class="btn btn-info"><!-- id="editable-sample_new" -->
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="{{ route('transporterdriversave') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="number" class="form-control" id="Phone"  required="required" name="phone" value="{{ old('phone') }}" placeholder="9874561230"/>
                                              @error('phone')
                                               <span class="text-danger"> {{ $message }} </span>
                                              @enderror
                                          </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" class="form-control" id="pan" name="pan" required="required" value="{{ old('pan') }}"  placeholder="PAN Number"/>
                                               @error('pan')
                                               <span class="text-danger"> {{ $message }} </span>
                                              @enderror
                                          </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-10">
                                              <input type="file" name="rc_book" class="default" required="required">
                                               @error('rc_book')
                                               <span class="text-danger"> {{ $message }} </span>
                                              @enderror
                                          </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-10">
                                              <input type="file" name="pan_card" class="default" required="required">
                                               @error('pan_card')
                                               <span class="text-danger"> {{ $message }} </span>
                                              @enderror
                                          </div>
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="col-md-10">
                                              <input type="file" name="licence" class="default" required="required">
                                               @error('licence')
                                               <span class="text-danger"> {{ $message }} </span>
                                              @enderror
                                          </div>
