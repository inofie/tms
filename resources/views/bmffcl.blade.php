...
<html>
    ...
    <div class="invoice-box">
      ...
      <table>
        <tr>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 13.33%; border-radius: 5px">21-March-2021</td>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 13.33%; border-radius: 5px">IMPORT</td>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 13.33%; border-radius: 5px">Y1697/20-21 </td>
        ...
        <tr>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 13.33%; border-radius: 5px">Ahmedabad</td>
         ...
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 13.33%; border-radius: 5px">Rajkot</td>
         <td style="border: 1px solid #dedede ; text-align: left; font-size: 10px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 13.33%; border-radius: 5px">To.</td>
         <td style="border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px; width: 13.33%; border-radius: 5px">Rajkot</td>
         <td style="border: 1px solid #dedede ; text-align: center; font-size: 15px; font-weight: 700;  padding: 5px 8px; line-height: 1.2; width: 20%; border-radius: 5px">H0727/20-21</td>
        </tr>
      </table>
      ...
      <table>
        <tr>
         <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px; font-weight: 700;  background-color: #e6e6e6; padding: 5px 8px; line-height: 1.2; width: 15%; border-radius: 5px">Truck No.</td>
          <td style="border: 1px solid #dedede ; text-align: left; font-size: 12px;  padding: 5px 8px; line-height: 1.2; width: 85%; border-radius: 5px">GJ03BV9633, GJ03BV9633, GJ03BV9633, GJ03BV9633, GJ03BV9633, GJ03BV9633</td>
        </tr>
      </table>
      ...
      <table>
              ...
              <tr style="height: 150px;vertical-align: baseline;">
                <td style="border: 1px solid #dedede ; text-align: center; font-size:10px; width:8%; line-height: 1.2; padding: 5px; border-radius: 5px;">01X20STD</td>
                <td style="border: 1px solid #dedede ; text-align: center; font-size: 12px; width: 47%; line-height: 1.2;  padding: 5px; border-radius: 5px;">
                               <table>
                                 <tr>
                                   ...
                                   <td style="width: 60%; border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px;  "></td>
                                 </tr>
                                 <tr>
                                   ...
                                   <td style="width: 60%; border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px;  ">UETU2754070</td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                   ...
                                   <td style="width: 60%; border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px;  ">JAS</td>
                                 </tr>
                                 <tr>
                                   ...
                                   <td style="width: 60%; border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px;  ">2878914</td>
                                 </tr>
                                 <tr>
                                   ...
                                   <td style="width: 60%;border: 1px solid #dedede ;text-align: center; font-size: 10px; line-height: 1.2; padding: 5px 8px;  ">CLEVELAND</td>
                                 </tr>
         ...
         <table>
           ...
           <tr>
            <td style="border: 1px solid #dedede ; text-align: left; font-size: 10px; font-weight: 700; width: 16.67%; line-height: 1.2;  padding: 5px; border-radius: 5px; background-color: #e6e6e6;">F.O.B Rs. </td>
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 10px; font-weight: 700; width: 16.67%; line-height: 1.2;  padding: 5px; border-radius: 5px;">jitesh bhai</td>
               ...
               <td style="border: 1px solid #dedede ; text-align: center; font-size: 10px; font-weight: 700; width: 16.67%; line-height: 1.2;  padding: 5px; border-radius: 5px;">Hatchback</td>
  ...
  <tr>
        <td style=" text-align: center; font-size: 12px; font-weight: 700; background-color: #e6e6e6;  width:15%; line-height: 1.2; padding: 5px; border-radius: 5px;" rowspan="3">N.B.</td>
        <td style=" text-align: left; font-size: 10px; font-weight: 700; width: 85%; line-height: 1.2;  padding: 5px; border-radius: 5px;"> • This G.C. Note Issued Under Terms &amp; Condition Printed Overleaf.</td>
        </tr>
        <tr>
          <td style=" text-align: left; font-size: 10px; font-weight: 700; width: 85%; line-height: 1.2;  padding: 5px; border-radius: 5px;">• We are not Responsible For Leakages.Breakages DamagesCondition Goods Accepted On Owner Risk.</td>
        </tr>
        <tr>
          <td style=" text-align: left; font-size: 10px; font-weight: 700; width: 85%; line-height: 1.2;  padding: 5px; border-radius: 5px;">• Subject to Ahmedabad Jurisdiction</td>
        </tr>
        </table>
...
<div  style="width: 100%;">
 ...
 <p  style="padding: 0px; margin:0% 0px 0px 0px; font-size: 12px; margin-bottom: 5px; font-weight: 700" >Terms and Condition :</p>
  ...
  <div style="width: 50%; float: left;">
    ...
    <p style="padding: 0px; margin:0% 0px 0px 0px;font-size: 10px; margin-bottom: 5px; text-align: justify;padding: 1%; ">• Condition contents and value of consignment are acknowledged to yogini transport(nereinafer called the company).The company carries the goods as packed of owners of consignor's risk.
...
perishable lying indelivered after 48 hrs. of arrival without any notice any other goods after 30day of arrival after due notice to </p>
  ...
  <div style="width: 50%; float: left;">
    <p style="padding: 0px; margin:1% 0px 0px 0px;font-size: 10px; margin-bottom: 5px; text-align: justify; padding: 1%;">the consignee and the claimants shall be entertained to the proceeds fright &amp; demurrage. • The company
